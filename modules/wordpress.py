...
""").split("\n")
    ...
    try:
        ...
        url = input(Fore.RED+" ┌─["+Fore.LIGHTBLUE_EX+"NoobWebHunter"+Fore.BLUE+"~"+Fore.WHITE+"@HOME"+Fore.RED+"/"+Fore.CYAN+"CMN"+Fore.RED+"/"+Fore.LIGHTYELLOW_EX+"WP"+Fore.RED+"/"+Fore.GREEN+"Get-Plugins"+Fore.RED+"""]
 └──╼ """+Fore.WHITE+"✠ ").lower()
        if url == "" or None:
    ...
    for plus in pl:
        ...
        try:
            ...
            if r.status_code == 200:
                print(Fore.GREEN+" [+] "+Fore.BLUE+'http://'+url +
                      '/wp-content/plugins/'+plus+Fore.WHITE+" > "+Fore.GREEN+" Found")

            else:
                print(Fore.RED+" [-]"+Fore.BLUE+'http://'+url +
                      '/wp-content/plugins/'+plus+Fore.WHITE+" > "+Fore.RED+" Not Found")
        except:
            print("")
            sys.exit()
...
def user():
    ...
    try:
        ...
        Url = input(Fore.RED+" ┌─["+Fore.LIGHTBLUE_EX+"NoobWebHunter"+Fore.BLUE+"~"+Fore.WHITE+"@HOME"+Fore.RED+"/"+Fore.CYAN+"CMN"+Fore.RED+"/"+Fore.LIGHTYELLOW_EX+"WP"+Fore.RED+"/"+Fore.GREEN+"Get-Username"+Fore.RED+"""]
 └──╼ """+Fore.WHITE+"✠ ").lower()

        s = requests.get("http://"+Url+"/wp-content/plugins/")
        if s.status_code == 200 or s.status_code == 500:
            print(Fore.RED+" [!] "+Fore.YELLOW+"Site NOT Wordpress")
            sys.exit()
        else:
            pass
        ...
        sys.exit()
    try:
        r = requests.get("http://"+Url+"/wp-json/wp/v2/users/").text
        j = json.loads(r)
        Count = len(j) - 1
        cn = 0 
        User = ''
